...
> = {
  ...
  building: {
    title: 'Building',
    description: 'Cody is actively working on this task. The pipeline is running.',
  },
  review: {
    title: 'In Review',
  ...
  retrying: {
    title: 'Retrying',
    description: 'A previous attempt failed. Cody is retrying the pipeline.',
  },
  done: {
    title: 'Done',
...
export function SubStatusTooltipContent({
  ...
  const info: Record<string, { title: string; description: string; action: string }> = {
    ...
    'needs-answer': {
      ...
      description: 'Cody has a question and is waiting for your answer before continuing.',
