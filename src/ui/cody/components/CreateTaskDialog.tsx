    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the structured fields below — Cody will use them to plan and implement.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-2">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              placeholder="e.g., src/ui/cody/, src/server/payload/collections/Users.ts"
            />
            <p className="text-xs text-muted-foreground">
              Helps Cody focus on the right part of the codebase.
            </p>
          </div>
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Checkboxes Cody will verify before marking done.
            </p>
          </div>
