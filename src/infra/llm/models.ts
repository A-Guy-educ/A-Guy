...
export const PROVIDER_MODEL_NAMES: Record<LLMProviderType, Record<AIModelKey, string>> = {
  ...
  [LLMProviderType.OPENAI_COMPATIBLE]: {
    IMAGE_TO_EXERCISE: 'MiniMax-M2.7-highspeed',
    EXERCISE_CHAT: 'MiniMax-M2.7-highspeed',
    PDF_TO_EXERCISE: 'MiniMax-M2.7-highspeed',
    ANSWER_VALIDATION: 'MiniMax-M2.7-highspeed',
    SUPPORT_GENERATION: 'MiniMax-M2.7-highspeed',
    CONTENT_TRANSLATION: 'MiniMax-M2.7-highspeed',
  },
} as const
