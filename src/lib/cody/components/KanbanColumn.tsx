 ...
 * @ai-summary Kanban column showing tasks in a stage
 */
'use client'
...
export function KanbanColumn({ id, title, tasks, onTaskClick, selectedTaskId }: KanbanColumnProps) {
  return (
    <div className="flex flex-col min-w-[280px] max-w-[320px]">
      ...
      <div className="flex-1 p-2 space-y-2 bg-gray-900/50 rounded-b-lg overflow-y-auto max-h-[calc(100vh-200px)]">
        {tasks.length === 0 ? (
