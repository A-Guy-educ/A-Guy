  ...
  fields: [
    {
      ...
      admin: {
        ...
        readOnly: true,
        components: {
          Cell: '@/ui/admin/LessonDuplicationReview/Cells/SourceLessonCell#SourceLessonCell',
        },
      },
    },
    {
    ...
    },
    {
      ...
      admin: {
        ...
        readOnly: true,
        components: {
          Cell: '@/ui/admin/LessonDuplicationReview/Cells/OutputLessonCell#OutputLessonCell',
        },
      },
    },
    {
