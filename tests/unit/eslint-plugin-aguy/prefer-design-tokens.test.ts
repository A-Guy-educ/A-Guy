    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'text-xs', raw: 'text-xs', suggestion: 'text-body-xs' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'text-sm', raw: 'text-sm', suggestion: 'text-body-sm' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'text-base', raw: 'text-base', suggestion: 'text-body-md' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'text-xl', raw: 'text-xl', suggestion: 'text-heading-xl or text-heading-lg' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'text-2xl', raw: 'text-2xl', suggestion: 'text-heading-xl' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'p-4', raw: 'p-4', suggestion: 'p-card-padding or p-card-padding-sm' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'p-6', raw: 'p-6', suggestion: 'p-card-padding' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'p-8', raw: 'p-8', suggestion: 'p-card-padding-lg' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'shadow-sm', raw: 'shadow-sm', suggestion: 'shadow-elevation-1' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'shadow-md', raw: 'shadow-md', suggestion: 'shadow-elevation-2 or shadow-card' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'shadow-lg', raw: 'shadow-lg', suggestion: 'shadow-elevation-3 or shadow-card' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'duration-100', raw: 'duration-100', suggestion: 'duration-fast' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'duration-200', raw: 'duration-200', suggestion: 'duration-normal' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [{ messageId: 'preferToken', data: { token: 'gap-4', raw: 'gap-4', suggestion: 'gap-content-gap' } }],
      },
    ],
  })
    ...
    invalid: [
      {
        ...
        errors: [
          { messageId: 'preferToken', data: { token: 'text-sm', raw: 'text-sm', suggestion: 'text-body-sm' } },
          { messageId: 'preferToken', data: { token: 'p-4', raw: 'p-4', suggestion: 'p-card-padding or p-card-padding-sm' } },
          { messageId: 'preferToken', data: { token: 'shadow-md', raw: 'shadow-md', suggestion: 'shadow-elevation-2 or shadow-card' } },
        ],
      },
    ],
  })
