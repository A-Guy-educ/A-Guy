...
describe('file-location ESLint rule', () => {
  ruleTester.run(
    'flags React component in src/components/',
    rule.default ?? rule,
    {
      valid: [],
      invalid: [
        {
          ...
          errors: [{ messageId: 'deprecatedLocation', data: { destination: 'src/ui/web/MyComponent.tsx' } }],
        },
      ],
    },
  )
  ...
  ruleTester.run(
    'flags React component in src/components/ui/',
    rule.default ?? rule,
    {
      valid: [],
      invalid: [
        {
          ...
          errors: [{ messageId: 'deprecatedLocation', data: { destination: 'src/ui/web/components/Button.tsx' } }],
        },
      ],
    },
  )
  ...
  ruleTester.run(
    'flags React component in src/components/courses/',
    rule.default ?? rule,
    {
      valid: [],
      invalid: [
        {
          ...
          errors: [{ messageId: 'deprecatedLocation', data: { destination: 'src/ui/web/courses/CourseCard.tsx' } }],
        },
      ],
    },
  )
  ...
  ruleTester.run(
    'ignores non-React code in src/components/',
    rule.default ?? rule,
    {
      valid: [
        {
  ...
  ruleTester.run(
    'ignores React component in src/ui/web/',
    rule.default ?? rule,
    {
      valid: [
        {
  ...
  ruleTester.run(
    'ignores React component in src/ui/admin/',
    rule.default ?? rule,
    {
      valid: [
        {
      ...
      invalid: [
        {
          ...
          errors: [{ messageId: 'deprecatedLocation', data: { destination: 'src/ui/web/Avatar.tsx' } }],
        },
      ],
    },
  )
      ...
      invalid: [
        {
          ...
          errors: [{ messageId: 'deprecatedLocation', data: { destination: 'src/ui/web/Nav.tsx' } }],
        },
      ],
    },
  )
  ...
  ruleTester.run(
    'ignores non-React code in src/lib/',
    rule.default ?? rule,
    {
      valid: [
        {
  ...
  ruleTester.run(
    'flags export function component in src/components/',
    rule.default ?? rule,
    {
      valid: [],
      invalid: [
  ...
  ruleTester.run(
    'flags export default class component in src/components/',
    rule.default ?? rule,
    {
      valid: [],
      invalid: [
  ...
  ruleTester.run(
    'ignores file in src/ui/shared/ without React imports',
    rule.default ?? rule,
    {
      valid: [
        {
  ...
  ruleTester.run(
    'ignores deeply nested component in src/ui/web/',
    rule.default ?? rule,
    {
      valid: [
        {
