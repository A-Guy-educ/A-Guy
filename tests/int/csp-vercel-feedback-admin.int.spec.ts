...
describe('CSP Configuration - Vercel Feedback Script on /admin', () => {
  ...
  it('should include *.gravatar.com in img-src for /admin routes', async () => {
    ...
    // Admin routes MUST have *.gravatar.com in img-src so www.gravatar.com avatar URLs are allowed
    // CSP host matching: 'gravatar.com' does NOT match 'www.gravatar.com' when base domain has subdomains
    // Using *.gravatar.com ensures all gravatar subdomains are permitted (www.gravatar.com, secure.gravatar.com, etc.)
