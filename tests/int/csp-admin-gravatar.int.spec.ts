...
/**
 * CSP Configuration Tests - Issue #1841
 *
 * Tests that Content-Security-Policy headers allow Gravatar images on /admin routes.
 *
 * Bug: Gravatar images (https://www.gravatar.com/avatar/...) are blocked on /admin
