...
/**
 * CSP Configuration Tests - Issue #1957
 *
 * Tests that Content-Security-Policy headers allow Gravatar images
 * to load on /admin routes.
 *
 * Bug: Gravatar images (https://www.gravatar.com/avatar/...) are blocked
 * on /admin because gravatar.com is not in the img-src directive.
 */
