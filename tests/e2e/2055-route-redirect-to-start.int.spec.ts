/**
 * Issue #2055: [P1] Frontend routes /ask /practice /stats /test /study all redirect to /start
 *
 * When an authenticated user navigates directly to /ask, /practice, /test, or /study
...
test.describe('Issue #2055 - Route redirects to /start instead of onboarding', () => {
  ...
  test('authenticated user without gradeLevel should be redirected to /onboarding/persona from /practice', async ({
    ...
    await setupAuthenticatedUser(
      page,
      {
        email: generateTestUserEmail('issue-2055'),
